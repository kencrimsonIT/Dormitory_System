...
public class DienChinhSachServiceImpl implements DienChinhSachService {
    ...
    @Override
    public List<DienChinhSach> getAll() { return dienChinhSachDAO.findAll(); }

    @Override
    public DienChinhSach getById(String maDCS) { return dienChinhSachDAO.findById(maDCS); }

    @Override
    public boolean create(DienChinhSach dcs) {
        if (dienChinhSachDAO.findById(dcs.getMaDCS()) != null) return false;
        return dienChinhSachDAO.save(dcs);
    }

    @Override
    public boolean update(DienChinhSach dcs) { return dienChinhSachDAO.update(dcs); }

    @Override
    public boolean delete(String maDCS) { return dienChinhSachDAO.delete(maDCS); }
}